...
def generateRocks(context, scaleX, skewX, scaleY, skewY, scaleZ, skewZ,
    ...
    if randomSeed:
        ...
        random.seed( ((t & 0xff000000) >> 24) +
                     ((t & 0x00ff0000) >>  8) +
                     ((t & 0x0000ff00) <<  8) +
                     ((t & 0x000000ff) << 24)   ) # HHH revise
        # Ref: https://stackoverflow.com/questions/27276135/python-random-system-time-seed
        # seed(int(time.time())) # original version
    else:
        seed(userSeed)
